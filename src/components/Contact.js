    ...
    <div className="contact-container" id="contact">
      <div className="icon-container">
        <div className="icon-container-1">
          ...
          <a href="https://twitter.com/mrzacsmith" target="_blank">
            <img src={twitter} alt="twitter" className="icon" />
          </a>
          <a href="https://www.linkedin.com/in/mrzacsmith/" target="_blank">
            <img src={linkedin} alt="linkedin" className="icon" />
          </a>
          <a href="https://www.youtube.com/c/ZacSmith" target="_blank">
        ...
        <div className="icon-container-2">
          ...
          <a href="https://medium.com/@mrzacsmith" target="_blank">
